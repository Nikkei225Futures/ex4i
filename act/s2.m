...
axis([0 20 500 2000]);
legend('目標刺激：横棒（目標刺激あり)','目標刺激；十字（目標刺激あり)','目標刺激；横棒（目標刺激なし)','目標刺激；十字（目標刺激なし)');
%legend('目標刺激：丸（目標刺激あり)','目標刺激；丸＋棒（目標刺激あり)','目標刺激；丸（目標刺激なし)','目標刺激；丸＋棒（目標刺激なし)');
xlabel('setsize');
ylabel('avg response time[ms]');

%学習によるポップアウト(プラスとマイナスの記号はよく見るから学習されている)によって、十字と横棒の課題では、https://www.jstage.jst.go.jp/article/jcss/3/4/3_4_4_119/_pdf
%どちらもポップアウトが起こりやすい例(十字とマイナス)だったため、どちらの場合も並列処理が発生し、入れ替えても反応時間が変わらなかった
%また、セットサイズが多いほどポップアウトが見やすいため、反応時間が下がる場合もあった。
%ポップアウトが起こりやすいのは目標刺激の特徴が多く、妨害刺激の特徴が少ない時
