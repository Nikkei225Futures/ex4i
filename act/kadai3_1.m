...
xSize = 1900;
ySize = 990;
%%[MainWindow, ScreenRect] = Screen('OpenWindow', scrnNum, gray, [(windRect(3)-xSize)/2, (windRect(4)-ySize)/2, (windRect(3)+xSize)/2, (windRect(4)-xSize)/2]);
...
lineRect = [(objectSize-stroke)/2 objectSize-margin*2-stroke (objectSize+stroke)/2 objectSize]; % 線の描画範囲

%%%%%変更箇所%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Screen('PutImage',circle,imread('A.jpg'),ovalRect);
Screen('PutImage',cplusline,imread('R.jpg'),ovalRect);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
