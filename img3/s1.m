...
width = 256;
 ...
 figure;
     ...
     colormap(gray);
     imagesc(img4Power);
     title('c. 縦縞4本power with dc');

     subplot(2, 2, 4);
     colormap(gray);
     imagesc(img4ndcPower);
     title('d. 縦縞4本power non dc');
 ...
 figure;
     ...
     colormap(gray);
     imagesc(img16);
     title('a. 縦縞16本 with dc');

     subplot(2,2,2);
     colormap(gray);
     imagesc(img16ndc);
     title('b. 縦縞16本 non dc');
 
     subplot(2,2,3);
     colormap(gray);
     imagesc(img16Power);
     title('c. 縦縞16本power with dc');

     subplot(2,2,4);
     colormap(gray);
     imagesc(img16ndcPower);
     title('d. 縦縞16本power non dc');
 
 figure;
     subplot(2,2,1);
     colormap(gray);
     imagesc(img64);
     title('a. 縦縞64本 with dc');
     
     subplot(2,2,2);
     colormap(gray);
     imagesc(img64ndc);
     title('b. 縦縞64本 non dc');
 
     subplot(2,2,3);
     colormap(gray);
     imagesc(img64Power);
     title('c. 縦縞64本power with dc');

     subplot(2,2,4);
     colormap(gray);
     imagesc(img64ndcPower);
     title('d. 縦縞64本power non dc');
